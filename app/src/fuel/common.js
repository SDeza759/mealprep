...
export function weekDates(weekStart) {
  const start = weekStart ? new Date(`${weekStart}T00:00:00`) : mondayOf(new Date());
...
export function fmtLongDate(d) { return `${DAYS_NAMES[(d.getDay() + 6) % 7]}, ${fmtDayDate(d)}`; }
